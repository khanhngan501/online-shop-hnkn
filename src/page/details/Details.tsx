...
function Details() {
    ...
    // useEffect(() => {
    //     if ( !Boolean(verifyComment.isValid) ) {
    //         console.log("Don't availiable button");
            
    //     } else if ( !Boolean(verifyName.isValid) ) {
    //         console.log("Don't availiable button");
            
    //     } else if ( !Boolean(verifyEmail.isValid) ) {
    //         console.log("Don't availiable button");
    //     } else if ( !Boolean(verifyPhoneNumber.isValid)) {
    //         console.log("Don't availiable button");
    //     } else {
    //         const infoUser = {
    //             name: nameRef.current?.value,
    ...
    //         }
    //         const comment = commentRef.current?.value
    //         console.log(`Thông tin khách hàng: ${infoUser} \n Comment: ${comment}`)
    //     }
    // }, [nameEntered, emailEntered, phoneNumberEntered])
    ...
    return (
        <section className="bg-white">
            ...
            {/* Comment/discussion */}
            <div className="border-[1px] rounded-md mb-4 p-2">
                {/* Writing new comment */}
                <div className="text-sm border-b-[1px] border-b-gray-500 mb-4">
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <div className="mb-2 w-full flex justify-center">
                            <button className={`p-2 bg-lime-600 text-white rounded-md`}
