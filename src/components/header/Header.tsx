...
function Header() {
    ...
    return (
        ...
        <section className="max-w-full mb-16 sticky top-0 z-50 h-[60px] max-sm:mb-4">
            <Dialog
                fullScreen
                open={open}
                onClose={handleClose}
            ...
            <header className={`${headerColor} h-full`}
            >
                <div className=" grid grid-cols-3 h-full items-center justify-between mb-6 max-sm:w-full max-sm:px-2 max-sm:mb-0 sm:px-6 sm:text-sm xl:w-full xl:px-20 2xl:mx-auto 2xl:max-w-screen-xl 2xl:px-0">
