    ...
    return(
        ...
        <section className="mx-auto max-w-screen-xl mb-16">
            ...
            <div className="relative w-full">
                ...
                />
                {/* Content hero header */}
                <div className="absolute top-0 w-full flex flex-col items-center text-center p-4">
                    {/* Image */}
                    <img src="https://i.postimg.cc/7ZzWLNCz/179f4b7afde32e020782f329f39f7d75d3894970-774x626.webp" 
                        className="max-w-[327px] mb-4"
                        alt="product image" 
                    />
                    <div className="flex items-center flex-col">
                        <h3 className="uppercase text-xl font-medium mb-4">Sản phẩm nổi bật</h3>
                        <h1 className="font-serif text-6xl tracking-wide mb-3">Tropical Green</h1>
                        <p className="tracking-wide mb-4">Tươi mới, hứng khởi và cảm giác vui vẻ</p>
                        <div className="py-4 px-8 w-fit rounded-full bg-slate-800 text-white cursor-pointer">
                            <span>Cửa hàng</span>
                        </div>
                    </div>
                </div>
